///////////////////////////////////////////////////////////
// Tracker scheme resource file - MODIFIED by SlimeDiamond - Clean UI Theme
//
// sections:
...
Scheme
{
	...
	BaseSettings
	{
		...
		FrameTitleButton.FgColor		"110 192 255 255"
		FrameTitleButton.BgColor		"Blank"
		FrameTitleButton.DisabledFgColor	"110 192 255 128"
		...
		Menu.ArmedBgColor				"110 192 255 255"
		Menu.TextInset					"6"
		...
		TextEntry.CursorColor		"110 192 255 255"
		...
		MainMenu.TextColor			"200 200 200 150"				[$WIN32]
		MainMenu.TextColor			"200 200 200 255"	[$GAMECONSOLE]
		MainMenu.ArmedTextColor		"LightBlue"	[$WIN32]
	...
	Borders
	{
		...
		FrameBorder
		{
			...
			Left
			{
				...
				"2"
				{
					"color" "110 192 255 50" //"Border.Dark"
					"offset" "1 1"
				}
			}
