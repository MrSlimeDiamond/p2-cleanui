...
Scheme
{
	...
	BaseSettings
	{
		...
		Button.TextColor				"white" // CleanUI :: This might fix smth, idk? it doesnt lol
		...
		FooterPanel.TextFont				"ButtonText_NC"			[!$GAMECONSOLE] // NOT CONSOLE
		...
		FooterPanel.TextColor				"DullWhite"
		...
		FooterPanel.BorderColor				"0 0 0 0"		[!$GAMECONSOLE]	
		FooterPanel.BorderArmedColor		"0 0 0 0"		[!$GAMECONSOLE]
		FooterPanel.BorderDepressedColor	"blank"					[!$GAMECONSOLE]
		FooterPanel.BorderColorAlt				"0 0 0 0"		[!$GAMECONSOLE]	
		FooterPanel.BorderArmedColorAlt		"0 0 0 0"		[!$GAMECONSOLE]
